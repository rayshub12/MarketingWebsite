...
<body class="fix-menu">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        <form class="md-float-material form-material" method="POST" action="<?php echo e(url('admin')); ?>" id="loginform">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <img src="<?php echo e(asset('assets/images/auth/Logo-small-bottom.png')); ?>" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="<?php echo e(asset('bower_components/jquery-slimscroll/js/jquery.slimscroll.js')); ?>"></script>
    <!-- modernizr js -->
    ...
    <!-- i18next.min.js -->
    <script type="text/javascript" src="<?php echo e(asset('bower_components/i18next/js/i18next.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('bower_components/jquery-i18next/js/jquery-i18next.min.js')); ?>"></script>
...
<?php /**PATH D:\GITCODE\MarketingWebsite\resources\views/admin/admin_login2.blade.php ENDPATH**/ ?>